...
export default function InspirationGallery() {
  ...
  /* 3. URL STATE MANAGEMENT (The "Sticky" Category Fix) */
  const [searchParams, setSearchParams] = useSearchParams();
  // Read 'cat' from URL, default to 0 (Banners)
  ...
  /* 4. FETCH DATA BASED ON URL PARAM */
  useEffect(() => {
    setLoading(true);
  ...
  /* 5. UPDATE URL WHEN TAB IS CLICKED */
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="max-w-[1280px] mx-auto px-6 py-14">
        ...
        {/* Category Filter - Fixed Selection */}
